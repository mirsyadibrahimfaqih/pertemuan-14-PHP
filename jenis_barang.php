      ...
      <div class="container-fluid">
        ...
        <div class="card">
              <div class="card-header">
                ...
                <br>
               <a class="btn mt-2" style="background-color:#17a2b8; color:#ffffff" href="formJenisBarang.php"><i class="fa fa-plus nav-icon mr-2"></i>Tambah Jenis Barang</a>
              </div>
                  ...
                  <tr>
                    ...
                    <td align="center">
                      <form action="controllers/JenisController.php" method="POST">
                        <a class="btn btn-success" href="DetailJenisBarang.php?hal=detailProduk&id=<?= $pro->id; ?>"><i class="fa fa-eye"></i></a>
                        <a class="btn btn-warning" href="EditJenisBarang.php?hal=editProduk&id=<?= $pro->id; ?>"><i class="fa fa-edit"></i></a>
